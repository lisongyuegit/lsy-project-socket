 ...
 */
public class GbHeartBack extends AbstractCallback {

    private static Logger logger = LoggerFactory.getLogger(GbHeartBack.class);
    ...
    CallbackMessage createCallBackMsg(ReceiveMessage msg) throws Exception {
        ...
        logger.info("["+msg.getImei()+"]GB心跳数据回写="+DefaultProtocolConvert.bytes2hexstring(callbackMessage.getHeaderMsg())+
