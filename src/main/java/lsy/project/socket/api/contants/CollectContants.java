...
public class CollectContants {
     ...
     */
    public static final String COLLECT_INFO_COLLECTION_NAME = "com.yidcloud.collect.collection.name";
    /**
     * 协议类型，在redis中key的前缀
     */
    public static final String PROTOCOL_TYPE_REDIS_PREFIX = "com.yidcloud.collect.protocol_type.";

    /**
     * 协议，在reids中，key的前缀
     */
    public static final String PROTOCOL_REDIS_PREFIX = "com.yidcloud.collect.protocol.";
     ...
     * 智能垃圾桶上传数据的唯一ID
     */
    public static final String TRASH_UPLOAD_SEQ = "com.plat.collect.trash:seq:%s";

    /**
     * 智能垃圾桶报警缓存
     */
    public static final String TRASH_ALERM = "com.plat.collect.trash:alerm:%s";
    ...
    public static final String OIL_TYPE_REDISKEY = "com.yidcloud.collect.oil_type";
